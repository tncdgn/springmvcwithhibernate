    ...
    <table class="responstable" id="personTable">
        ...
        <c:forEach items="${listUser}" var="user" >
            <tr id="${user.personId}">
                ...
                <td id="selectedPhoneNumber">${user.telephone}</td>
...
<div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
    <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
        ...
        <div id="cd-login"> <!-- log in form -->
            <form:form class="cd-form" action="user" method="post" commandName="personForm" >
                <p class="fieldset">
                ...
                <p class="fieldset">
                    ...
                    <form:input class="full-width has-padding has-border" id="add-number" type="text" placeholder="Phone Number" path="telephone"></form:input>
                    <span class="cd-error-message">Please fill this area!</span>
                </p>
                <p class="fieldset">
...
<div class="cd-user-modal2"> <!-- this is the entire modal form, including the background -->
    <div class="cd-user-modal2-container2"> <!-- this is the container wrapper -->
        ...
        <div id="cd-edit"> <!-- log in form -->
            <form:form class="cd-form" action="user/edit" method="post" commandName="userEdit" >
                <p class="fieldset">
                ...
                <p class="fieldset">
                    <label class="image-replace cd-email" > Phone Number</label>
                    <form:input class="full-width has-padding has-border" id="edit-number" type="text" placeholder="Phone Number" path="telephone"></form:input>
                    <span class="cd-error-message">Please fill this area!</span>
                </p>
